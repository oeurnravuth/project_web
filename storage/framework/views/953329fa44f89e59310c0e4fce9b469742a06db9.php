...
<?php $__env->startSection('contents'); ?>
    <form action="<?php echo e(route('admin.users.post_add_new')); ?>" method="post" id="form-submit-add"
                        ...
                        <div class="x_content">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" required <?php echo e(old('name')); ?>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="password" class="form-control col-md-7 col-xs-12" required value="<?php echo e(old('password')); ?>"
                                           name="password" placeholder="" type="password">
                                </div>
                            </div>
                            <div class="form-group text-right">
                                <div class="col-md-6 col-md-offset-3">
                                    <a href="<?php echo e(route('admin.users.list')); ?>"><button type="button" class="btn btn-danger back-to-list">Cancel</button></a>
